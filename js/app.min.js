...
(e>c||e===c&&(b===k._lastChangedValue||k.values(b)===l.min))&&(e=c,f=a(this),g=b)}),h=this._start(b,g),h===!1?!1:(this._mouseSliding=!0,this._handleIndex=g,f.addClass("ui-state-active").focus(),i=f.offset(),j=!a(b.target).parents().addBack().is(".ui-slider-handle"),this._clickOffset=j?{left:0,top:0}:{left:b.pageX-i.left-f.width()/2,top:b.pageY-i.top-f.height()/2-(parseInt(f.css("borderTopWidth"),10)||0)-(parseInt(f.css("borderBottomWidth"),10)||0)+(parseInt(f.css("marginTop"),10)||0)},this.handles.hasClass("ui-state-hover")||this._slide(b,g,d),this._animateOff=!0,!0))},_mouseStart:function(){return!0},_mouseDrag:function(a){var b={x:a.pageX,y:a.pageY},c=this._normValueFromMouse(b);return this._slide(a,this._handleIndex,c),!1},_mouseStop:function(a){return this.handles.removeClass("ui-state-active"),this._mouseSliding=!1,this._stop(a,this._handleIndex),this._change(a,this._handleIndex),this._handleIndex=null,this._clickOffset=null,this._animateOff=!1,!1},_detectOrientation:function(){this.orientation="vertical"===this.options.orientation?"vertical":"horizontal"},_normValueFromMouse:function(a){var b,c,d,e,f;return"horizontal"===this.orientation?(b=this.elementSize.width,c=a.x-this.elementOffset.left-(this._clickOffset?this._clickOffset.left:0)):(b=this.elementSize.height,c=a.y-this.elementOffset.top-(this._clickOffset?this._clickOffset.top:0)),d=c/b,d>1&&(d=1),0>d&&(d=0),"vertical"===this.orientation&&(d=1-d),e=this._valueMax()-this._valueMin(),f=this._valueMin()+d*e,this._trimAlignValue(f)},_start:function(a,b){var c={handle:this.handles[b],value:this.value()};return this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._trigger("start",a,c)},_slide:function(a,b,c){var d,e,f;this.options.values&&this.options.values.length?(d=this.values(b?0:1),2===this.options.values.length&&this.options.range===!0&&(0===b&&c>d||1===b&&d>c)&&(c=d),c!==this.values(b)&&(e=this.values(),e[b]=c,f=this._trigger("slide",a,{handle:this.handles[b],value:c,values:e}),d=this.values(b?0:1),f!==!1&&this.values(b,c))):c!==this.value()&&(f=this._trigger("slide",a,{handle:this.handles[b],value:c}),f!==!1&&this.value(c))},_stop:function(a,b){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._trigger("stop",a,c)},_change:function(a,b){if(!this._keySliding&&!this._mouseSliding){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._lastChangedValue=b,this._trigger("change",a,c)}},value:function(a){return arguments.length?(this.options.value=this._trimAlignValue(a),this._refreshValue(),void this._change(null,0)):this._value()},values:function(b,c){var d,e,f;if(arguments.length>1)return this.options.values[b]=this._trimAlignValue(c),this._refreshValue(),void this._change(null,b);if(!arguments.length)return this._values();if(!a.isArray(arguments[0]))return this.options.values&&this.options.values.length?this._values(b):this.value();for(d=this.options.values,e=arguments[0],f=0;d.length>f;f+=1)d[f]=this._trimAlignValue(e[f]),this._change(null,f);this._refreshValue()},_setOption:function(b,c){var d,e=0;switch("range"===b&&this.options.range===!0&&("min"===c?(this.options.value=this._values(0),this.options.values=null):"max"===c&&(this.options.value=this._values(this.options.values.length-1),this.options.values=null)),a.isArray(this.options.values)&&(e=this.options.values.length),a.Widget.prototype._setOption.apply(this,arguments),b){case"orientation":this._detectOrientation(),this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-"+this.orientation),this._refreshValue();break;case"value":this._animateOff=!0,this._refreshValue(),this._change(null,0),this._animateOff=!1;break;case"values":for(this._animateOff=!0,this._refreshValue(),d=0;e>d;d+=1)this._change(null,d);this._animateOff=!1;break;case"min":case"max":this._animateOff=!0,this._refreshValue(),this._animateOff=!1;break;case"range":this._animateOff=!0,this._refresh(),this._animateOff=!1}},_value:function(){var a=this.options.value;return a=this._trimAlignValue(a)},_values:function(a){var b,c,d;if(arguments.length)return b=this.options.values[a],b=this._trimAlignValue(b);if(this.options.values&&this.options.values.length){for(c=this.options.values.slice(),d=0;c.length>d;d+=1)c[d]=this._trimAlignValue(c[d]);return c}return[]},_trimAlignValue:function(a){if(this._valueMin()>=a)return this._valueMin();if(a>=this._valueMax())return this._valueMax();var b=this.options.step>0?this.options.step:1,c=(a-this._valueMin())%b,d=a-c;return 2*Math.abs(c)>=b&&(d+=c>0?b:-b),parseFloat(d.toFixed(5))},_valueMin:function(){return this.options.min},_valueMax:function(){return this.options.max},_refreshValue:function(){var b,c,d,e,f,g=this.options.range,h=this.options,i=this,j=this._animateOff?!1:h.animate,k={};this.options.values&&this.options.values.length?this.handles.each(function(d){c=100*((i.values(d)-i._valueMin())/(i._valueMax()-i._valueMin())),k["horizontal"===i.orientation?"left":"bottom"]=c+"%",a(this).stop(1,1)[j?"animate":"css"](k,h.animate),i.options.range===!0&&("horizontal"===i.orientation?(0===d&&i.range.stop(1,1)[j?"animate":"css"]({left:c+"%"},h.animate),1===d&&i.range[j?"animate":"css"]({width:c-b+"%"},{queue:!1,duration:h.animate})):(0===d&&i.range.stop(1,1)[j?"animate":"css"]({bottom:c+"%"},h.animate),1===d&&i.range[j?"animate":"css"]({height:c-b+"%"},{queue:!1,duration:h.animate}))),b=c}):(d=this.value(),e=this._valueMin(),f=this._valueMax(),c=f!==e?100*((d-e)/(f-e)):0,k["horizontal"===this.orientation?"left":"bottom"]=c+"%",this.handle.stop(1,1)[j?"animate":"css"](k,h.animate),"min"===g&&"horizontal"===this.orientation&&this.range.stop(1,1)[j?"animate":"css"]({width:c+"%"},h.animate),"max"===g&&"horizontal"===this.orientation&&this.range[j?"animate":"css"]({width:100-c+"%"},{queue:!1,duration:h.animate}),"min"===g&&"vertical"===this.orientation&&this.range.stop(1,1)[j?"animate":"css"]({height:c+"%"},h.animate),"max"===g&&"vertical"===this.orientation&&this.range[j?"animate":"css"]({height:100-c+"%"},{queue:!1,duration:h.animate}))},_handleEvents:{keydown:function(c){var d,e,f,g,h=a(c.target).data("ui-slider-handle-index");switch(c.keyCode){case a.ui.keyCode.HOME:case a.ui.keyCode.END:case a.ui.keyCode.PAGE_UP:case a.ui.keyCode.PAGE_DOWN:case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(c.preventDefault(),!this._keySliding&&(this._keySliding=!0,a(c.target).addClass("ui-state-active"),d=this._start(c,h),d===!1))return}switch(g=this.options.step,e=f=this.options.values&&this.options.values.length?this.values(h):this.value(),c.keyCode){case a.ui.keyCode.HOME:f=this._valueMin();break;case a.ui.keyCode.END:f=this._valueMax();break;case a.ui.keyCode.PAGE_UP:f=this._trimAlignValue(e+(this._valueMax()-this._valueMin())/b);break;case a.ui.keyCode.PAGE_DOWN:f=this._trimAlignValue(e-(this._valueMax()-this._valueMin())/b);break;case a.ui.keyCode.UP:case a.ui.keyCode.RIGHT:if(e===this._valueMax())return;f=this._trimAlignValue(e+g);break;case a.ui.keyCode.DOWN:case a.ui.keyCode.LEFT:if(e===this._valueMin())return;f=this._trimAlignValue(e-g)}this._slide(c,h,f)},click:function(a){a.preventDefault()},keyup:function(b){var c=a(b.target).data("ui-slider-handle-index");this._keySliding&&(this._keySliding=!1,this._stop(b,c),this._change(b,c),a(b.target).removeClass("ui-state-active"))}}})}(jQuery),function(a){a.fn.flexVerticalCenter=function(b){var c=a.extend({cssAttribute:"margin-top",verticalOffset:0,parentSelector:null},b||{});return this.each(function(){var b=a(this),d=function(){var a=c.parentSelector?b.parents(c.parentSelector).first().height():b.parent().height();b.css(c.cssAttribute,(a-b.height())/2+parseInt(c.verticalOffset))};d(),a(window).resize(d),b.find("img").load(d)})}}(jQuery);var range_slider=function(a){if(a&&"string"!=typeof a.selector)throw"init() needs a selector string or an object which contains a selector string called 'element'";if("number"!=typeof a.min||"number"!=typeof a.max||a.min>a.max)throw"init() needs a min and max in its parameter object, which are both numbers and the min is smaller than the max";if(void 0!=a.left_scrubber_pos&&"number"!=typeof a.left_scrubber_pos)throw"The value inside left_scrubber_pos is not a number";if(void 0!=a.right_scrubber_pos&&"number"!=typeof a.right_scrubber_pos)throw"The value inside left_scrubber_pos is not a number";var b,c,d,e=this,f=$(a.selector).empty(),g=$("<div />").addClass("labels").appendTo(f),h=$("<span />").attr("id","left-label").appendTo(g),i=$("<span />").addClass("right-label").appendTo(g),j=$("<div />").addClass("slider-bar").appendTo(f),k=$("<div />").addClass("left-scrubber scrubber").appendTo(j),l=$("<div />").addClass("right-scrubber scrubber").appendTo(j),m=$("<div />").addClass("range").appendTo(j),n=function(a){var b=a/(j.width()-2*v),c=u-t;return 1/0==b&&(b=0),t+c*b},o=function(a){return(a-t)/(u-t)*(j.width()-2*v)},p=function(a){return Math.round(a/x)*x},q=function(a){return Math.floor(a/x)*x},r=function(a){return Math.ceil(a/x)*x},s=function(){m.css(a.rounded?{left:b+v-v/2,width:c-b}:{left:b+v,width:c-b-v})},t=a.min,u=a.max,v=k.width(),w="string"==typeof a.unit?a.unit:"",x="number"==typeof a.round_by?a.round_by:1,y=!1,z=!1,A=!1,B=!1;if(t=q(t),u=r(u),k.width()!==l.width())throw"The left and right scrubbers width's do not match, they must be the same for this to work correctly";e.updateMin=function(a){if(a=parseFloat(a),a!=q(a)&&console.warn("value is not a devision of the round_by value, "+a+" has been rounded to "+p(a)),isNaN(a))console.error("value parsed in is not a number.");else{var d=n(b),f=n(c);isNaN(d)&&(d=t),isNaN(f)&&(f=u),t=q(a),e.updateScrubbers(d,f)}},e.updateMax=function(a){if(a=parseFloat(a),a!=r(a)&&console.warn("value is not a devision of the round_by value, "+a+" has been rounded to "+p(a)),isNaN(a))console.error("value parsed in is not a number.");else{var d=n(b),f=n(c-v);isNaN(d)&&(d=t),isNaN(f)&&(f=u),u=r(a),e.updateScrubbers(d,f)}},e.updateRange=function(a,b){if(a=parseFloat(a),b=parseFloat(b),!isNaN(a)&&!isNaN(b)&&b>=a){var c=t>=b||a>=u;a>u?(e.updateMax(b),e.updateMin(a)):(e.updateMin(a),e.updateMax(b)),c&&e.updateScrubbers(a,b)}else console.error("values parsed in are not numbers or left scrubber value is larger than the right scrubber value.")},e.updateLeftScrubber=function(d){isNaN(parseFloat(d))?console.error("value parsed in is not a number."):(b=o(t>=d?t:d),b=b>=c-v-o(t+x)?c-v-o(t+x):b,b=b>0?b:0,h.text(a.fixed?p(n(b)).toFixed(1)+w:p(n(b))+w),k.css("left",b),s())},e.updateRightScrubber=function(d){isNaN(parseFloat(d))?console.error("value parsed in is not a number."):(c=o(d>=u?u:d)+v,c=c<=b+v+o(t+x)?b+v+o(t+x):c,isNaN(c)&&(c=j.width()-v),i.text(a.fixed?p(n(c-v)).toFixed(1)+w:p(n(c-v))+w),l.css("left",c),s())},e.updateScrubbers=function(a,d){a=parseFloat(a),d=parseFloat(d),!isNaN(a)&&!isNaN(d)&&d>=a?(b=o(t),c=o(u),isNaN(b)&&(b=0),isNaN(c)&&(c=j.width()-v),e.updateLeftScrubber(a),e.updateRightScrubber(d)):console.error("values parsed in are not numbers or left scrubber value is larger than the right scrubber value.")},e.release=function(b){"function"==typeof a.release&&a.release(b)},this.updateScrubbers("number"==typeof a.left_scrubber_pos?a.left_scrubber_pos:t,"number"==typeof a.right_scrubber_pos?a.right_scrubber_pos:u),k.mouseover(function(){y=!0}),l.mouseover(function(){z=!0}),k.mouseout(function(){y=!1}),l.mouseout(function(){z=!1}),j.bind("mousedown touchstart",function(a){a.preventDefault();var f=Math.abs,g=a.clientX?a.clientX:a.originalEvent.touches[0].pageX,h=g-j.offset().left,i=f(h-b),m=f(h-c);B=!1,A=!1,y?(d=h-parseFloat(k.css("left")),A=!0):z?(d=h-parseFloat(l.css("left")),B=!0):(d=v/2,m>i?(A=!0,e.updateLeftScrubber(n(h-d))):(B=!0,e.updateRightScrubber(n(h-v-d))))}),$(document).bind("mousemove touchmove",function(a){var b=a.clientX?a.clientX:a.originalEvent.touches[0].pageX,c=b-j.offset().left;if(A){var f=c-d;e.updateLeftScrubber(n(f))}if(B){var g=c-d-v;e.updateRightScrubber(n(g))}}),$(document).bind("mouseup touchend",function(){(A||B)&&e.release({min:p(n(b)),max:p(n(c-v))}),A=!1,B=!1})};!function(){if($(".filter__slider").length>0){new range_slider({selector:"#slider__price",unit:" т.р.",min:50,max:2e3,left_scrubber_pos:180,right_scrubber_pos:640,round_by:1,rounded:!0}),new range_slider({selector:"#slider__year",unit:"",min:1992,max:2014,left_scrubber_pos:1998,right_scrubber_pos:2002,round_by:1,rounded:!0}),new range_slider({selector:"#slider__engine",unit:" л.",min:.6,max:6,left_scrubber_pos:1.6,right_scrubber_pos:2.5,round_by:.1,rounded:!0,fixed:!0})}$.ajax({url:"http://www.carqueryapi.com/api/0.3/?callback=?&cmd=getMakes",dataType:"jsonp",success:function(a){$(".filter__make").find("option").remove(),$(".filter__make").append("<option value='' disabled selected>Выберите марку</option>");for(var b=0;b<a.Makes.length-1;b++)$(".filter__make").append($("<option></option>").attr("value",a.Makes[b].make_id).text(a.Makes[b].make_display))}}),$(".filter__make").change(function(){$(".filter__model").find("option").remove(),$(".filter__model").append("<option>Загрузка...</option>"),$.ajax({url:"http://www.carqueryapi.com/api/0.3/?callback=?&cmd=getModels&make="+$(this).val(),dataType:"jsonp",success:function(a){$(".filter__model").find("option").remove();for(var b=0;b<a.Models.length-1;b++)$(".filter__model").append($("<option></option>").attr("value",a.Models[b].model_name).text(a.Models[b].model_name))}})}),$(".slider__menu a span").flexVerticalCenter({cssAttribute:"padding-top"}),$(".slider__menu--menuonly a span").flexVerticalCenter({cssAttribute:"padding-top"}),function(){if($(".slider__slide").length>0){void 0==$("#slider").attr("data-count")&&$("#slider").attr("data-count",0);var a=parseInt($("#slider").attr("data-count")),b=$("#slider .slider__slide").size()-1}$("#slider .slider__menu a").on("click",function(b){b.preventDefault(),$("#slider .slider__slide:animated").size()>0||(a=$(this).attr("href").split("#slide-")[1]-1,$("#slider .slider__slide.active").fadeOut(300,function(){$("#slider .slider__slide.active").removeClass("active"),$("#slider .slider__slide").eq(a).addClass("active"),$("#slider .slider__slide").eq(a).fadeIn(300),$("#slider").attr("data-count",a)}),$("#slider .slider__menu li.active").removeClass("active"),$("#slider .slider__menu li").eq(a).addClass("active"))}),$("#slider .slider__nav a").on("click",function(c){if(c.preventDefault(),!($("#slider .slider__slide:animated").size()>0)){var d;d=$(this).hasClass("slider__nav--next")?1:0,a=0==d?0==a?b+1:a:a==b?-1:a,$("#slider .slider__slide.active").fadeOut(300,function(){$(this).removeClass("active"),1==d?a++:a--,$("#slider .slider__slide").eq(a).addClass("active"),$("#slider .slider__slide").eq(a).fadeIn(300),$("#slider .slider__menu li.active").removeClass("active"),$("#slider .slider__menu li").eq(a).addClass("active"),$("#slider").attr("data-count",a)})}})}(),$.fn.placeholder.input&&$.fn.placeholder.textarea||($.fn.placeholder.input?$("textarea").placeholder():$("input, textarea").placeholder()),function(){var a="easeInOutSine";$(".specslider__nav a").on("click",function(b){var c=$(this),d=c.parent().parent().find(".specslider__wrapper"),e=d.find(".specslider__item").length-4;void 0==d.attr("data-count")&&d.attr("data-count",0);var f=parseInt(d.attr("data-count")),g=parseInt(d.css("margin-left")),h=parseInt(d.find(".specslider__item").css("width"));if(b.preventDefault(),!d.is(":animated")){if(c.hasClass("specslider__nav--prev")){if(0>=f)return;g+=h,f-=1}else e>f&&(g-=h,f+=1);d.animate({marginLeft:g+"px"},{duration:500,easing:a}),d.attr("data-count",f)}})}()}(jQuery);var BrowserDetect={init:function(){this.browser=this.searchString(this.dataBrowser)||"Other",this.version=this.searchVersion(navigator.userAgent)||this.searchVersion(navigator.appVersion)||"Unknown"},searchString:function(a){for(var b=0;b<a.length;b++){var c=a[b].string;if(this.versionSearchString=a[b].subString,-1!=c.indexOf(a[b].subString))return a[b].identity}},searchVersion:function(a){var b=a.indexOf(this.versionSearchString);if(-1!=b)return parseFloat(a.substring(b+this.versionSearchString.length+1))},dataBrowser:[{string:navigator.userAgent,subString:"Chrome",identity:"Chrome"},{string:navigator.userAgent,subString:"MSIE",identity:"Explorer"},{string:navigator.userAgent,subString:"Firefox",identity:"Firefox"},{string:navigator.userAgent,subString:"Safari",identity:"Safari"},{string:navigator.userAgent,subString:"Opera",identity:"Opera"}]};BrowserDetect.init();